...
| 항목 | array[다음 중 하나: link:#app_2_2_get_response_body["app_2.2_get_response_body"], array[]] | 참  a| 
...
| namespaceScopedResources | 배열[link:#namespaceScopedResources["namespaceScopedResources"]] | 참  a| 
