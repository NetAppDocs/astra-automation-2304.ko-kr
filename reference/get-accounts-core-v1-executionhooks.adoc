...
| 항목 | array[다음 중 하나: link:#executionHook_1_2_get_response_body["executionHook_1.2_get_response_body"], array[]] | 참  a| 
...
|===
[[executionHook_1_2_get_response_body]]
[role="api-collapsible-fifth-title"]
...
* "post" - 지정된 작업 후에 실행 후크가 실행됩니다. "snapshot" 작업의 값은 "pre"와 "post"입니다. "backup" 작업의 값은 "pre"와 "post"입니다. "restore" 작업의 값은 "post"입니다.
