...
NOTE: Astra Control REST API 23.06 릴리스에는 새로 알려진 문제가 없습니다. 이 API 릴리스는 Astra Control Center 23.04 및 Astra Control Service 23.06과 함께 사용됩니다. 아래에 설명된 문제는 이전 릴리즈에서 발견되었으며 현재 릴리스에서도 계속 적용됩니다.
...
* https://docs.netapp.com/us-en/astra-control-center-2304/release-notes/known-issues.html["Astra Control Center의 알려진 문제입니다"^]
